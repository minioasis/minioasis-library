...
public class Series extends TableImpl<SeriesRecord> {
    ...
    private static final long serialVersionUID = 1110366482;
     ...
     */
    public final TableField<SeriesRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>PUBLIC.SERIES.NAME</code>.
     */
    public final TableField<SeriesRecord, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
