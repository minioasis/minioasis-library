...
public class FormData extends TableImpl<FormDataRecord> {
    ...
    private static final long serialVersionUID = -939400779;

    /**
     * The reference instance of <code>PUBLIC.FORM_DATA</code>
     */
    ...
    /**
     * The column <code>PUBLIC.FORM_DATA.ID</code>.
     */
    public final TableField<FormDataRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>PUBLIC.FORM_DATA.DATA</code>.
     */
    public final TableField<FormDataRecord, String> DATA = createField("DATA", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.FORM_DATA.DATA_TYPE</code>.
     */
    public final TableField<FormDataRecord, String> DATA_TYPE = createField("DATA_TYPE", org.jooq.impl.SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * Create a <code>PUBLIC.FORM_DATA</code> table reference
     */
    public FormData() {
    ...
    /**
     * Create an aliased <code>PUBLIC.FORM_DATA</code> table reference
     */
