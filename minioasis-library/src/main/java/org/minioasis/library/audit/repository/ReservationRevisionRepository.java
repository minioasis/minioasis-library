...
@Repository
@Transactional
public class ReservationRevisionRepository {

	@PersistenceContext
	private EntityManager entityManager;
	
	@SuppressWarnings("unchecked")
	public Page<Object[]> listDeletedReservationsIn(String username, int days, Pageable pageable) {
        ...
        AuditQuery query = auditReader.createQuery()
					        		.forRevisionsOfEntity(Reservation.class, false, true)
        ...
        long total = totalDeletedReservationsIn(username, days);

        return new PageImpl<Object[]>(results, pageable, total);
    }
	
	private long totalDeletedReservationsIn(String username, int days) {
