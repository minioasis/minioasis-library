...
@Repository
@Transactional
public class TelegramUserRevisionRepository {

	@PersistenceContext
	private EntityManager entityManager;
	
	@SuppressWarnings("unchecked")
	public Page<Object[]> listDeletedTelegramUsersIn(String username, int days, Pageable pageable) {
        ...
        AuditQuery query = auditReader.createQuery()
					        		.forRevisionsOfEntity(TelegramUser.class, false, true)
        ...
        long total = totalDeletedTelegramUsersIn(username, days);

        return new PageImpl<Object[]>(results, pageable, total);
    }
	
	private long totalDeletedTelegramUsersIn(String username, int days) {
