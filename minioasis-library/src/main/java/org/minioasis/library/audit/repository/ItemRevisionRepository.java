...
@Repository
@Transactional
public class ItemRevisionRepository {

	@PersistenceContext
	private EntityManager entityManager;
	
	@SuppressWarnings("unchecked")
	public Page<Object[]> listDeletedItemsIn(String username, int days, Pageable pageable) {
        ...
        long total = totalDeletedItemsIn(username, days);

        return new PageImpl<Object[]>(results, pageable, total);
    }
	
	private long totalDeletedItemsIn(String username, int days) {
